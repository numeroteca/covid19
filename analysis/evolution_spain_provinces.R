...
# Escala lineal
png(filename=paste("img/covid19_casos-registrados-por-provincia-lineal.png", sep = ""),width = 1400,height = 1000)
...
# Escala logarítmica
png(filename=paste("img/covid19_casos-registrados-por-provincia-log.png", sep = ""),width = 1400,height = 1000)
data_cases_sp_provinces %>%
  ggplot() +
  geom_line(aes(date,cases_accumulated,group=province) ) +
  geom_point(aes(date,cases_accumulated,group=province), size = 0.5 ) +
