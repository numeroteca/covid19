...
)), colnames = c('Provincia', 'CCAA', 'Casos acumulado (días desde)', 'Casos (última fecha)', 'Muertes acumulado (días desde)', 'Muertes (última fecha)','PCR diario (días desde)', 'PCR acumulado (días desde)', 'Hospitalizados (días desde)'   ),
...
as.datatable(
formattable( data_cases_sp_provinces %>% arrange( desc(date) ) %>% select(-province,-ine_code)),
options = list(pageLength = 52)
)
```
