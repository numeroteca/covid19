...
data_cases_sp_provinces <- data_cases_sp_provinces <- readRDS(file = "../data/output/spain/covid19-provincias-spain_consolidated.rds") %>% mutate(
...
# as.datatable(
  formattable( ia7data, 
               ...
               list(
                  ...
                  area(col = 2:(days - threashold)) ~ color_tile("#fff7ec", "#ffa01e") 
               )
  )
...
ia7data <- data_cases_sp_provinces %>% select(province,date,cases_PCR_7days,poblacion,weekday) %>% filter ( weekday== "martes") %>%
  mutate(
  ia7 =  round( cases_PCR_7days / poblacion * 100000, digits = 0)
...
formattable( ia7data, 
             ...
             list(
  # ia14 = color_tile("#fff7ec", "#ffa01e"),
  area(col = 2:26) ~ color_tile("#fff7ec", "#ffa01e") 
))
...
formattable( ia7data, 
             list(
  # ia14 = color_tile("#fff7ec", "#ffa01e"),
  area(col = 2:10) ~ color_tile("#fff7ec", "#ffa01e") 
))
...
formattable( ia14data, 
             list(
  # ia14 = color_tile("#fff7ec", "#ffa01e"),
  area(col = 2:11) ~ color_tile("#fff7ec", "#ffa01e") 
))
# ,options = list(pageLength = 19)
# )
``` 
...
formattable( data, 
             list(
  # ia14 = color_tile("#fff7ec", "#ffa01e"),
  area(col = 2:(days - threashold + 2)) ~ color_tile("#f3f3f3", "#6ba5c6") 
))
# ,options = list(pageLength = 19)
# )
``` 
...
formattable( data, 
             list(
  # ia14 = color_tile("#fff7ec", "#ffa01e"),
  area(col = 2:(days - threashold)) ~ color_tile("#fCfAfA", "#e14f4f") 
))
# ,options = list(pageLength = 19)
# )
``` 
